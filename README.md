...
- [x] Scaffold Astro project from the provided template (Node.js 26, Astro 6)
- [x] Set up content collections for milestone data (ENIAC, System/360, Intel 4004)
- [x] Build the interactive timeline component
- [x] Implement architecture diagram view
- [x] Implement mobile stepper layout
- [x] Write exhibit content in `topic_name.mdx`
- [x] Style pass to match shared museum template

### Stage 3: Final Exhibit (Upcoming)

- [x] Integration testing with merged museum site
- [x] Accessibility and mobile responsiveness review
- [x] Final content review and submission
